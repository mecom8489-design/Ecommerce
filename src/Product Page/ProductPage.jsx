      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="max-w-8xl mx-auto p-4 flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 w-full">
            ...
            {/* Product Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 w-350">
              {products.map((product) => (
                <div
                  key={product.id}
                  className="bg-white p-4 hover:shadow-lg transition-shadow rounded-xl relative group cursor-pointer"
                  onClick={() =>
                ...
                >
                  ...
                  {/* Product Image */}
                  <div className="w-full h-40 sm:h-48 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden mb-2">
                    <img
                      src={product.image}
                      alt={product.name}
